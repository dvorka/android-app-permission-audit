 ...
 * Activité d'affichage du détail d'une categorie
...
public class CategoryDetail extends Activity {
	ListView applicationList; // Composant graphique gérant la liste de permissions
	
	/*
	 * onCreate :
	 * Exécuté à la création de l'activité. Récupère
	 * les informations sur la categorie reçue par
    ...
    public void onCreate(Bundle savedInstanceState) {        
        ...
        // Récupération des donnees de l'intent
        Intent thisIntent = getIntent();
        String categoryId = Long.toString(thisIntent.getExtras().getLong("categoryId"));
        
        // Récuperation des informations sur la catégorie
        ...
        if (data.getCount() == 1) {
        	...
        	// Récupère le nombre d'applications qui sont dans cette catégorie et l'affiche
        	...
        	// Préference pour l'affichage des applications, nom ou package
        	...
        	// Récupération des applications de la catégorie et affichage dans la liste
        	...
        	// La catégorie n'est pas trouvée dans la base de données
